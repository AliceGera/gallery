...
class AppScope implements IAppScope {
  ...
  late final GalleryApi _galleryApi;
  @override
  ...
  AppScope(this._sharedPreferences) {
    ...
    // Places API service
    _galleryApi = GalleryApi(dio);
    _galleryService = _initGalleryService();
  }
  ...
  Dio _initDio(Iterable<Interceptor> additionalInterceptors) {
    ...
    dio.options
      ..baseUrl = GalleryApiStrings.basePath
  ...
  GalleryService _initGalleryService() {
    _galleryRepository = GalleryRepository(_galleryApi);
    return GalleryService(_galleryRepository);
  }
}
